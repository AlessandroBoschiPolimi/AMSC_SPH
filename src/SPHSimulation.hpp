...
//template <size_t D>
//void SPHSimulation<D>::InitializeSimulation_Box()
//{
...
//template <size_t D>
//void SPHSimulation<D>::InitializeSimulation_Tray()
//{
//	// Setup for ''Dam breaking''
//	int maxx = 100, maxy = 100, maxz = 100;
//	vec_t vertical_direction{ 0, -1 };
//	vec_t zero_direction{ 0, 0 };
//	for (float x = 10; x < maxx / 2; x += 0.5)
//	{
//		for (float y = 10; y < maxy / 2; y += 0.5)
//		{
//			for (float z = 10; z < maxz / 2; z += 0.5)
//			Particle<D> p;
//			p.Type = FLUID;
...
//template <size_t D>
//void SPHSimulation<D>::BuildXWall(float y, float begin, float end, float delta)
//{
//	/*
...
//}
//template <size_t D>
//void SPHSimulation<D>::BuildYWall(float x, float begin, float end, float delta)
//{
//	/*
